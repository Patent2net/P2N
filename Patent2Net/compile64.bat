...
pyinstaller -y --noupx --specpath=specs --hidden-import sklearn.neighbors.typedefs --clean --version-file=version-P2N-Cluster.txt P2N-Cluster.py
...
xcopy /Y root\* dist\
copy /Y ipcr_xml.2015 dist\Patent2Net64\
